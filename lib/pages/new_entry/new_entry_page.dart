...
import 'package:pill_reminder_app/models/errors.dart';
import 'package:pill_reminder_app/models/medicine_type.dart';
import 'package:pill_reminder_app/pages/home_page.dart';
import 'package:pill_reminder_app/pages/new_entry/new_entry_bloc.dart';
import 'package:pill_reminder_app/pages/success_screen/success_screen.dart';
...
class _NewEntryPageState extends State<NewEntryPage> {
  late TextEditingController nameIDController;
  ...
  void dispose() {
    ...
    nameIDController.dispose(); // เพิ่มบรรทัดนี้
  ...
  void initState() {
    ...
    nameIDController = TextEditingController(); // เพิ่มบรรทัดนี้
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const PanelTitle(
                title: 'Name ID',
                isRequired: true, // เปลี่ยนเป็น false หากไม่ต้องการให้เป็นฟิลด์บังคับ
              ),
              TextFormField(
                maxLength: 20,
                ...
                child: SizedBox(
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      ...
                      String? nameID; // เพิ่มตัวแปรนี้
                      String? medicineName;
                      int? dosage;

                      if (nameIDController.text == "") {
                        _newEntryBloc.submitError(EntryError.nameNull);
                        return;
                      }
                      if (nameIDController.text != "") {
                        nameID = nameIDController.text;
                      }// เพิ่มการตรวจสอบซ้ำชื่อยาเหมือนเดิม
    ...
    _newEntryBloc.errorState$!.listen((EntryError error) {
      switch (error) {
        ...
        case EntryError.startTime:
          ...
          break;
        case EntryError.nameIDNull: // เพิ่มการตรวจสอบข้อผิดพลาดสำหรับ nameID
          displayError("Please enter the name ID");
          break;
